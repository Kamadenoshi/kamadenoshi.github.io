...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="styles/igroviye.css" />
  ...
  <body>
    ...
    <section>
      <div class="shap"><img src="images/21.jpg" /></div>
      <div class="text"><h1>Игровые виды спорта</h1></div>
    </section>
    <article>
      <h1>ОБ УСЛУГЕ</h1>
      <div class="blocks">
        <div class="ust">
          <div class="zach">
            <h2>Возможности</h2>
            <p>
              Вы можете тренироваться сами или под руководством профессиональных
              инструкторов. Доступен любой вариант – отработка командной игры с
              опытным наставником или совершенствование собственных навыков.
            </p>
          </div>
          <div class="nash">
            <h2>Почему именно мы?</h2>
            <p>
              Все тренеры направления игровых программ являются
              квалифицированными специалистами с высшим спортивным образованием.
              Среди них мастера и кандидаты в мастера спорта, чемпионы и
              многократные призеры российских и международных соревнований.
            </p>
          </div>
        </div>
        <div class="slider middle">
          <div class="slides">
            ...
            <div class="slide s1">
              <img src="images/22.jpg" class="img" />
            </div>
            <div class="slide">
              <img src="images/23.jpg" class="img" />
            </div>
            <div class="slide">
              <img src="images/24.jpg" class="img" />
            </div>
            <div class="slide">
              <img src="images/25.jpeg" class="img" />
            </div>
          </div>
